...
import net.egordmitriev.popshows.pojo.tmdb.response.MovieLiteResponse;
import net.egordmitriev.popshows.pojo.tmdb.response.SerieLiteResponse;
import net.egordmitriev.popshows.ui.modelviews.PersonView;
