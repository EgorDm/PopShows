...
import net.egordmitriev.popshows.pojo.watchall.ReviewModel;
import net.egordmitriev.popshows.pojo.watchall.UserModel;
import net.egordmitriev.popshows.pojo.watchall.WatchlistModel;
import net.egordmitriev.popshows.ui.activities.base.TabsActivity;
import net.egordmitriev.popshows.ui.fragments.ProfileAboutFragment;
import net.egordmitriev.popshows.ui.fragments.media.DefaultMediaListFragment;
import net.egordmitriev.popshows.ui.fragments.media.WatchlistListFragment;
