...
public class ColorPicker extends View {
    ...
    public ColorPicker(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ColorPicker, 0, 0);

        try {
            mOrientation = a.getInteger(R.styleable.ColorPicker_orientation, HORIZONTAL);

            if (!isInEditMode()) {
                final int colorsArrayResId = a.getResourceId(R.styleable.ColorPicker_colors, -1);
            ...
            final int selected = a.getInteger(R.styleable.ColorPicker_selectedColorIndex, -1);
